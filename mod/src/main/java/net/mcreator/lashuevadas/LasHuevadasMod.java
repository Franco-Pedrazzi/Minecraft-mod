package net.mcreator.lashuevadas;
...
@Mod("las_huevadas")
public class LasHuevadasMod {
	public static final Logger LOGGER = LogManager.getLogger(LasHuevadasMod.class);
	public static final String MODID = "las_huevadas";

	public LasHuevadasMod() {
